...
for image_id, data in results.items():
    ...
    print(f"  Label RGB vs Target Area Value - LAB 색상 유사도 (Delta E): {similarity_target}")
    print(f"  Label RGB vs Target Area Value - RGB 거리: {distance_target}")
    print(f"  Label RGB vs Target Area Value - 채널별 RGB 거리: {channel_distance_target}\n")
    print(f"  Label RGB vs Corrected Target Area Value - LAB 색상 유사도 (Delta E): {similarity_corrected}")
    print(f"  Label RGB vs Corrected Target Area Value - RGB 거리: {distance_corrected}")
    print(f"  Label RGB vs Corrected Target Area Value - 채널별 RGB 거리: {channel_distance_corrected}")
    print("\n")
